...
using PandaML::KNNClassifier;
using PandaML::PCA;
using PandaML::Adam;
using PandaML::BaseGradientModel;
using PandaML::BinaryCrossEntropy;
using PandaML::DecisionTreeClassifier;
using PandaML::EuclideanDistance;
using PandaML::GiniCriterion;
using PandaML::ILoss;
using PandaML::IOptimizer;
using PandaML::ISplitCriterion;
using PandaML::ISupervisedModel;
using PandaML::ITransformer;
using PandaML::IUnsupervisedModel;
using PandaML::KMeans;
using PandaML::LinearRegression;
using PandaML::LogisticRegression;