...
Var<int32_t> add(Var<int32_t> a, Var<int32_t> b) {
    return a + b;
}
Var<double> divide(Var<double> a, Var<double> b) {
    return a / b;
}
int main() {
    Var<int32_t> x = 100;
    Var<int32_t> y = 50;
    Var<int32_t> sum = add(x, y);
    std::cout<<"Sum result: " + sum<<'\n';
    std::cout<<"Division result: " + divide(10.0, 2.3)<<'\n';
    Var<std::string> greeting = "Hello";
    std::cout<<greeting + " World " + 123<<'\n';
}
